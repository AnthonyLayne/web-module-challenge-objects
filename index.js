...
console.log(createMenuItem("California Burger", 6, "Entree"));
console.log(createMenuItem("Cheese Pizza", 4, "Italian Food"));
console.log(createMenuItem("Chicken Taco", 3, "Tasty Food"));
